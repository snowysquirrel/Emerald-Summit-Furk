...
/datum/species/dullahan/get_skin_list()
	return list(
		...
		"Emerald Summit" = SKIN_COLOR_PALE_SCARLET_REACH,
...
/datum/species/dullahan/get_skin_list_tooltip()
	return list(
		...
		"Emerald Summit <span style='border: 1px solid #161616; background-color: #[SKIN_COLOR_PALE_SCARLET_REACH];'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>" = SKIN_COLOR_PALE_SCARLET_REACH,
