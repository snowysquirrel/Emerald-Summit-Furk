...
//		if(H.has_status_effect(/datum/status_effect/debuff/necran_cross)) //this don't exist at the time of adding the blast. But its here if we port it later.
...
//				if(/datum/patron/divine/undivided) //think someones planning to port undivided. This is here when you do!
