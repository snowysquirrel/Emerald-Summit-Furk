// Frost Bolt — Cryomancy staple projectile. Applies one frost stack on hit.
// MVP config: click_to_activate FALSE (fires in facing direction).
// Suffix _magi2 on spell and projectile types to avoid collisions with the existing
// proc_holder /obj/effect/proc_holder/spell/invoked/projectile/frostbolt + /obj/projectile/magic/frostbolt.
...
/datum/action/cooldown/spell/projectile/frost_bolt_magi2
	...
	projectile_type = /obj/projectile/magic/frostbolt_magi2
	projectile_type_arc = /obj/projectile/magic/frostbolt_magi2/arc
...
/obj/projectile/magic/frostbolt_magi2
	name = "frost bolt"
	icon_state = "ice_2"
	damage = 30
	npc_damage_mult = 2
...
/obj/projectile/magic/frostbolt_magi2/arc
	name = "arced frost bolt"
	damage = 23
	arcshot = TRUE

/obj/projectile/magic/frostbolt_magi2/on_hit(target)
	. = ..()
	if(ismob(target))
		var/mob/M = target
