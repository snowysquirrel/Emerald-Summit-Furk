// Energetic Blast — Telomancy line AOE. 4-tile line of pure arcyne force that strikes
// for blunt damage and hurls victims 3 paces back. Shield-blockable; a successful guard
// stops propagation further down the line.

/datum/action/cooldown/spell/energetic_blast_magi2
	name = "Energetic Blast"
	desc = "Channel a wave of raw arcyne energy in a 4-tile line in front of me, striking foes \
		for blunt damage and hurling them back 3 paces. A successful guard stops the wave."
...
/datum/action/cooldown/spell/energetic_blast_magi2/cast(atom/cast_on)
	. = ..()
...
/obj/effect/temp_visual/energetic_blast_magi2
