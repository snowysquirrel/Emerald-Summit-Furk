// Thunderstrike — Fulgurmancy AOE. High-damage center then two outward concentric layers.
...
/datum/action/cooldown/spell/thunderstrike_magi2/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/thunderstrike_magi2/proc/thunderstrike_damage(turf/effect_layer, stage_damage)
