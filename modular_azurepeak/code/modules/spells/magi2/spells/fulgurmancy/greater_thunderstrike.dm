// Greater Thunderstrike — Fulgurmancy Mastery (T4 additive variant). Port of Azure-Peak
// greater_thunderstrike.dm. Placeholder mastery upstream too. Reuses our ported
// thunderstrike temp visuals (trap/thunderstrike, thunderstrike_actual).

#define GTSTRIKE_CENTER_DAMAGE 80
#define GTSTRIKE_OUTER_DAMAGE 80
#define GTSTRIKE_TELEGRAPH 16

/datum/action/cooldown/spell/greater_thunderstrike_magi2
...
/datum/action/cooldown/spell/greater_thunderstrike_magi2/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/greater_thunderstrike_magi2/proc/strike_all(turf/centerpoint)
	...
	for(var/turf/T in range(aoe_range, centerpoint))
		...
		for(var/mob/living/L in T.contents)
			...
			// Upstream's second SHOCK_VISUAL_ONLY electrocute_act dropped (flag missing in ES).
