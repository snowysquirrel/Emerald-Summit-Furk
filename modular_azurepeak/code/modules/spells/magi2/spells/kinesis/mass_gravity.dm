// Mass Gravity — Kinesis AOE knockdown. 3x3, longer telegraph, weaker per-target damage than Gravity.
...
/datum/action/cooldown/spell/mass_gravity_magi2/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/mass_gravity_magi2/proc/mass_crush(turf/centerpoint)
