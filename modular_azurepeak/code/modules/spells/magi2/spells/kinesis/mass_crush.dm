// Mass Crush — Kinesis Mastery (T4 additive variant). Port of Azure-Peak mass_crush.dm.
// A 5x5 gravitational crush: highly telegraphed, devastating, armor-piercing.

/datum/action/cooldown/spell/mass_crush_magi2
...
/datum/action/cooldown/spell/mass_crush_magi2/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/mass_crush_magi2/proc/mass_crush_strike(turf/centerpoint, mob/living/carbon/human/caster)
