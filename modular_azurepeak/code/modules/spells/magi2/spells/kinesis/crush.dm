// Crush — Kinesis single-target gravity strike. Telegraphed, then crushes the aimed body part.

/datum/action/cooldown/spell/crush_magi2
	name = "Crush"
	desc = "Compress gravitational force onto a single point, crushing the aimed body part. \
		It is telegraphed and can be walked out of. Crushes through armor with exceptional force. \
		Slows struck targets briefly. Deals 100% more damage to simple-minded creechurs."
...
/datum/action/cooldown/spell/crush_magi2/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/crush_magi2/proc/crush_strike(turf/T, mob/living/carbon/human/caster)
