// Ensnare — small AOE root, brief telegraph then locks everyone in the area for 5s.
// Reuses ES's existing /obj/effect/temp_visual/ensnare visual.
...
/datum/action/cooldown/spell/ensnare_magi2/cast(atom/cast_on)
	. = ..()
...
/datum/action/cooldown/spell/ensnare_magi2/proc/apply_ensnare(turf/T, mob/living/caster)
