// Magician's Rock — Geomancy utility cantrip. Tears a single boulder from the earth at the caster's feet.
// The heftier cousin of Magician's Stone (ported from Azure-Peak PR #6666).

/datum/action/cooldown/spell/magicians_rock_magi2
	name = "Magician's Rock"
	desc = "Tear a boulder from the earth itself and materialize it at my feet."
...
/datum/action/cooldown/spell/magicians_rock_magi2/cast(atom/cast_on)
	. = ..()
	...
	user.visible_message(
		span_notice("[user] clenches [user.p_their()] fist and a boulder tears itself from the earth."),
		span_notice("I tear a boulder from the earth itself."),
	)
	return TRUE
