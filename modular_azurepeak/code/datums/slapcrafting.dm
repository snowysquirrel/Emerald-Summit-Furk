/* ported from tgstation: https://github.com/tgstation/tgstation/blob/master/code/datums/elements/slapcrafting.dm
with edits to work for roguecode */ 
...
/datum/element/slapcrafting/proc/topic_handler(atom/source, user, href_list)
	...
	for(var/valid_type in cur_recipe.tools)
