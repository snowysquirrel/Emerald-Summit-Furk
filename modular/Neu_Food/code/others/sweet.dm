...
/obj/item/reagent_containers/food/snacks/jamtallowslice
	...
	desc = "A portion of jammy paradise, bearing the same hues as the Summit's morning skies. It yearns to be savored not by its lonesome, but upon a slice of bread - ideally, butterdoughed or toasted."
	icon = 'modular/Neu_Food/icons/others/sweet.dmi'
	icon_state = "jamtallow_slice"
	faretype = FARE_POOR
	list_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
...
/obj/item/reagent_containers/food/snacks/marmaladeslice
	...
	desc = "A portion of jammy paradise, bearing the same hues as the Summit's evening seas. It yearns to be savored not by its lonesome, but upon a slice of bread - ideally, butterdoughed or toasted."
	icon = 'modular/Neu_Food/icons/others/sweet.dmi'
	icon_state = "marmalade_slice"
	faretype = FARE_POOR
	list_reagents = list(/datum/reagent/consumable/nutriment = SNACK_DECENT)
