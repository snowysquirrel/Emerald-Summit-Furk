...
// Crafting migrated to SScooking (meat_recipes.dm): frysteak + pepper/onion/carrot -> pepper/onion/
// carrot steak. The hand-coded attackby was removed to match Azure-Peak and stop the duplicate path.
